...
```yaml
phase: round-24-phase-A-shipped + consult-001-refinements-in-progress (2 of 7 done)
iter: 281
...
next_action: iter 282 — next consult-001 recommendation. With H5 (iter 280) + H4 (iter 281) shipped, the remaining cheap/medium consult fixes:
